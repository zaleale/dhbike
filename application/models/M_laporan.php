...
class M_laporan extends CI_Model{
	...
	// function get_lap_laba_rugi($bulan){
	// 	$hsl=$this->db->query("SELECT DATE_FORMAT(jual_tanggal,'%d %M %Y %H:%i:%s') as jual_tanggal,d_jual_barang_nama,d_jual_barang_satuan,d_jual_barang_harpok,d_jual_barang_harjul,(d_jual_barang_harpok-d_jual_barang_harjul) AS keunt,d_jual_qty,d_jual_diskon,((d_jual_barang_harpok-d_jual_barang_harjul)*d_jual_qty)-(d_jual_qty*d_jual_diskon) AS untung_bersih FROM tbl_jual JOIN tbl_detail_jual ON jual_nofak=d_jual_nofak WHERE DATE_FORMAT(jual_tanggal,'%M %Y')='$bulan'");
	// 	return $hsl;
	// }
	...
	// function get_total_lap_laba_rugi($bulan){
	// 	$hsl=$this->db->query("SELECT DATE_FORMAT(jual_tanggal,'%M %Y') AS bulan,d_jual_barang_nama,d_jual_barang_satuan,d_jual_barang_harpok,d_jual_barang_harjul,(d_jual_barang_harpok-d_jual_barang_harjul) AS keunt,d_jual_qty,d_jual_diskon,SUM(((d_jual_barang_harpok-d_jual_barang_harjul)*d_jual_qty)-(d_jual_qty*d_jual_diskon)) AS total FROM tbl_jual JOIN tbl_detail_jual ON jual_nofak=d_jual_nofak WHERE DATE_FORMAT(jual_tanggal,'%M %Y')='$bulan'");
	// 	return $hsl;
	// }
}