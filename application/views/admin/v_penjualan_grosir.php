   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Transaksi
                    ...
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="btn btn-sm btn-success" style="margin-left: 650px;">Cari Produk!</a>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <table>
                <tr>
                    <td style="width:760px;" rowspan="2"><button type="submit" class="btn btn-info"> Simpan</button></td>
