...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN PENJUALAN PERTANGGAL</h4></center><br/></td>
</tr>
...
?>
    <tr>
        ...
        <td style="text-align:left;"><?php echo $kobar;?></td>
        ...
        <td style="text-align:left;"><?php echo 'Rp '.number_format($diskon);?></td>
