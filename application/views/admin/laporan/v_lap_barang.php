...
<tr>
    <td colspan="2" style="width:800px;paddin-left:30px;"><center><h4>LAPORAN DATA BARANG</h4></center><br/></td>
</tr>
...
echo "<tr style='background-color:#ccc;'>
    ...
    <td width='40%' align='left'>Nama Barang</td>
...
$nomor=1;
    ...
    $group=$d['kategori_nama'];
        ...
        <tr>
                ...
                <td style="vertical-align:center;text-align:left;"><?php echo $d['barang_id']; ?></td>
                ...
                <td style="vertical-align:center;padding-right:5px;text-align:center;"><?php echo 'Rp '.number_format($d['barang_harjul']); ?></td>
