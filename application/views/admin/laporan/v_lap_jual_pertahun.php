...
echo "<tr style='background-color:#ccc;'>
    ...
    <td width='8%' align='left'>No Faktur</td>
    <td width='13%' align='left'>Tanggal</td>
    <td width='10%' align='left'>Kode Barang</td>
    <td width='30%' align='left'>Nama Barang</td>
    <td width='7%' align='left'>Satuan</td>
    <td width='7%' align='left'>Harga Jual</td>
...
$nomor=1;
    ...
    $group=$d['bulan'];
        ...
        <tr>
                ...
                <td style="vertical-align:top;text-align:left;"><?php echo $d['jual_nofak']; ?></td>
                <td style="vertical-align:top;text-align:left;"><?php echo $d['jual_tanggal']; ?></td>
                <td style="vertical-align:top;text-align:left;"><?php echo $d['d_jual_barang_id']; ?></td>
                <td style="vertical-align:top;text-align:left;"><?php echo $d['d_jual_barang_nama']; ?></td> 
                <td style="vertical-align:top;text-align:left;"><?php echo $d['d_jual_barang_satuan']; ?></td>
                <td style="vertical-align:top;text-align:right;"><?php echo 'Rp '.number_format($d['d_jual_barang_harjul']); ?></td>
                <td style="vertical-align:top;text-align:center;"><?php echo $d['d_jual_qty']; ?></td>
                <td style="vertical-align:top;text-align:center;"><?php echo 'Rp '.number_format($d['d_jual_diskon']); ?></td>
                <td style="vertical-align:top;text-align:right;"><?php echo 'Rp '.number_format($d['d_jual_total']); ?></td> 
        </tr>
