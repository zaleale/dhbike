...
<th colspan="11" style="text-align:left;">Bulan : <?php echo $b['bulan'];?></th>
    ...
    <tr>
        ...
        <th style="text-align: center;">Keuntungan Per Unit</th>
        <th style="text-align: center;">Item Terjual</th>
        <th style="text-align: center;">Diskon</th>
        <th style="text-align: right;">Untung Bersih</th>
    </tr>
</thead>
<tbody>
<?php 
...
?>
    <tr>
        ...
        <td style="text-align:left;"><?php echo 'Rp '.number_format($harpok);?></td>
        <td style="text-align:left;"><?php echo 'Rp '.number_format($harjul);?></td>
        <td style="text-align:center;"><?php echo 'Rp '.number_format($untung_perunit);?></td>
